...
export function CookieBanner() {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 z-[1000] flex flex-col sm:flex-row items-center justify-between p-4 sm:p-6 gap-4 w-full bg-white border-t border-[var(--color-border)] shadow-[0_-4px_20px_rgba(10,25,47,0.12)] transition-transform duration-300 ease-in-out ${
