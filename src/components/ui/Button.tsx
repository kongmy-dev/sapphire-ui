  ...
  'inline-flex items-center justify-center gap-2 font-sans font-semibold transition-all cursor-pointer no-underline select-none active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100 outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus-ring)] focus-visible:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        outline:
          'bg-transparent text-[var(--color-text-strong)] rounded-[var(--radius-btn)] border-[1.5px] border-[var(--color-text-strong)] hover:bg-[var(--color-text-strong)] hover:text-[var(--color-card-bg)]',
        ghost:
        ...
        link:
          'bg-transparent text-[var(--color-accent-text)] hover:text-[var(--color-text-strong)] p-0 underline-offset-4 hover:underline border-none',
        premium:
